...
class TrainerSpaCLR:
    def __init__(self, args, n_clusters, network, optimizer, log_dir, device='cuda', is_gat=True):
        ...
        self.device = device
        self.args = args
        self.w_g2i = args.w_g2i       #1
        self.w_s2i = args.w_s2i       #1
        self.w_g2g = args.w_g2g       #0.1
        self.w_s2s = args.w_s2s       #0.1
        self.w_s2g = args.w_s2g       #0.1
        self.w_i2i = args.w_i2i       #0.1
        self.w_recon = args.w_recon       #0.3
        self.w_graph_loss = args.w_graph_loss       #0.5
            ...
            with tqdm(total=len(validloader)) as t:
                ...
                for i, batch in enumerate(validloader):
                    ...
                    if self.is_gat:
                        ...
                        #xg, hg, _ = self.network.forward_gene_graph(test_graph)
                        xg = zg_all[idx]
                        hg = hg_all[idx]
                        if not (xi==1).all():
